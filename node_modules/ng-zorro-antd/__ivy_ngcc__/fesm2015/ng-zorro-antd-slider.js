...
function NzSliderComponent_nz_slider_step_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("nzVertical", ctx_r943.nzVertical)("nzLowerBound", ctx_r943.bounds.lower)("nzUpperBound", ctx_r943.bounds.upper)("nzMarksArray", ctx_r943.marksArray)("nzIncluded", ctx_r943.nzIncluded);
} }
function NzSliderComponent_nz_slider_handle_5_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "nz-slider-handle", 8);
} if (rf & 2) {
    const handle_r946 = ctx.$implicit;
    const ctx_r944 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("nzVertical", ctx_r944.nzVertical)("nzOffset", handle_r946.offset)("nzValue", handle_r946.value)("nzActive", handle_r946.active)("nzTipFormatter", ctx_r944.nzTipFormatter)("nzTooltipVisible", ctx_r944.nzTooltipVisible)("nzTooltipPlacement", ctx_r944.nzTooltipPlacement);
} }
function NzSliderComponent_nz_slider_marks_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("nzVertical", ctx_r945.nzVertical)("nzMin", ctx_r945.nzMin)("nzMax", ctx_r945.nzMax)("nzLowerBound", ctx_r945.bounds.lower)("nzUpperBound", ctx_r945.bounds.upper)("nzMarksArray", ctx_r945.marksArray)("nzIncluded", ctx_r945.nzIncluded);
} }
function NzSliderHandleComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ctx_r947.style)("nzTitle", ctx_r947.tooltipTitle)("nzTrigger", null)("nzPlacement", ctx_r947.nzTooltipPlacement);
} }
function NzSliderHandleComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ctx_r948.style);
} }
function NzSliderMarksComponent_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 2);
} if (rf & 2) {
    const attr_r950 = ctx.$implicit;
    ɵngcc0.ɵɵclassProp("ant-slider-mark-active", attr_r950.active);
    ɵngcc0.ɵɵproperty("ngStyle", attr_r950.style)("innerHTML", attr_r950.label, ɵngcc0.ɵɵsanitizeHtml);
} }
function NzSliderStepComponent_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 2);
} if (rf & 2) {
    const mark_r952 = ctx.$implicit;
    ɵngcc0.ɵɵclassProp("ant-slider-dot-active", mark_r952.active);
    ɵngcc0.ɵɵproperty("ngStyle", mark_r952.style);
} }
function MarkObj() { }
if (false) {
    /** @type {?|undefined} */
