...
function NzMessageContainerComponent_nz_message_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const message_r736 = ctx.$implicit;
    const i_r737 = ctx.index;
    ɵngcc0.ɵɵproperty("nzMessage", message_r736)("nzIndex", i_r737);
} }
...
function NzMessageComponent_ng_container_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("innerHTML", ctx_r743.nzMessage.content, ɵngcc0.ɵɵsanitizeHtml);
} }
let globalCounter = 0;
/**
...
/** @nocollapse */ NzMessageService.ɵprov = ɵɵdefineInjectable({ factory: function NzMessageService_Factory() { return new NzMessageService(ɵɵinject(NzSingletonService), ɵɵinject(Overlay), ɵɵinject(INJECTOR), ɵɵinject(ComponentFactoryResolver), ɵɵinject(ApplicationRef)); }, token: NzMessageService, providedIn: NzMessageServiceModule });
